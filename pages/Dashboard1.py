...
/* Sidebar text colors */
.stSidebar p, .stSidebar div, .stSidebar span, .stSidebar label, .stSidebar h4 {
    color: white !important;
}
.stSidebar select {
...
def categorize_utilization(row, vaccine_name):
    """Categorize utilization rate based on thresholds"""
...
def main():
    ...
    # Summary metrics (outside tabs for overview)
    ...
    with col1:
        st.markdown(f'<div class="tab-metric-box"><div class="tab-metric-label">Total Woredas</div><div class="tab-metric-value">{total_woredas}</div></div>', unsafe_allow_html=True)
    with col2:
        st.markdown(f'<div class="tab-metric-box"><div class="tab-metric-label">Total Doses Distributed</div><div class="tab-metric-value">{total_distributed:,.0f}</div></div>', unsafe_allow_html=True)
    with col3:
        st.markdown(f'<div class="tab-metric-box"><div class="tab-metric-label">Total Doses Administered</div><div class="tab-metric-value">{total_administered:,.0f}</div></div>', unsafe_allow_html=True)
    with col4:
    ...
    with tab2:
        ...
        with col_w1:
            st.markdown(f'<div class="tab-metric-box"><div class="tab-metric-label">Total Woredas</div><div class="tab-metric-value">{total_woredas}</div></div>', unsafe_allow_html=True)
        with col_w2:
            st.markdown(f'<div class="tab-metric-box"><div class="tab-metric-label">Acceptable</div><div class="tab-metric-value">{category_counts.get("Acceptable", 0)}</div></div>', unsafe_allow_html=True)
        with col_w3:
            st.markdown(f'<div class="tab-metric-box"><div class="tab-metric-label">Unacceptable</div><div class="tab-metric-value">{category_counts.get("Unacceptable", 0)}</div></div>', unsafe_allow_html=True)
        with col_w4:
            st.markdown(f'<div class="tab-metric-box"><div class="tab-metric-label">Low Utilization</div><div class="tab-metric-value">{category_counts.get("Low Utilization", 0)}</div></div>', unsafe_allow_html=True)
    ...
    with tab4:
        ...
        if selected_vaccine == "All":
            st.info("Select a specific vaccine to view the bar chart.")
            return
